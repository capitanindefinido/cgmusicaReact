# Tienda CG
Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de merchandasing del músico y cantautor chileno Cristóbal Gacitúa y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
